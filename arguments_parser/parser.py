...
parser.add_argument(f'--{info_arg_name}', f'-{info_arg_name[0]}',
                    required=False,
                    type=str,
                    nargs='+',
                    metavar='',
...
parser.add_argument(f'--{collections_arg_name}', f'-{collections_arg_name[0]}',
                    required=False,
                    type=str,
                    nargs='+',
                    action='append',
...
parser.add_argument(f'--{uploads_arg_name}', f'-{uploads_arg_name[0]}',
                    required=False,
                    type=str,
                    nargs='+',
                    metavar='',
...
parser.add_argument(f'--{purity_arg_name}',
                    required=False,
                    type=str,
                    nargs='+',
                    metavar='',
...
parser.add_argument(f'--{category_arg_name}',
                    required=False,
                    type=str,
                    nargs='+',
                    metavar='',
...
parser.add_argument(f'--{sync_arg_name}', f'-{sync_arg_name[0]}',
                    required=False,
                    action="store_true",
                    help=help_messages.HELP_MSG_SYNC)

parser.add_argument(f'--{downloads_path_arg_name}', f'-{downloads_path_arg_name[0]}',
                    required=False,
                    type=str,
                    metavar='',
...
parser.add_argument(f'--{verbose_arg_name}', '-v',
                    required=False,
                    action="store_true",
                    default=DEFAULT_VERBOSE,
                    help=help_messages.HELP_MSG_VERBOSE)

parser.add_argument(f'--{workers_arg_name}', f'-{workers_arg_name[0]}',
                    required=False,
                    type=int,
                    metavar='count',
